    ...
    public class ExamManager 
    {
        ...
        public List<ExamMetaData> GetScheduledExams(int PlatformID)
        {
            List<ExamMetaData> Li = (from Ex in CTX.Exams
                                     ...
                                     select new ExamMetaData { Course_Name = Crs.CourseName, Exam_Degree = Ex.Exam_FullDegree, Exam_Duration = Ex.Exam_Duration, Exam_Id = Ex.Exam_Id, Exam_Name = Ex.Exam_Name, Date = Ex_Dep.Exam_Date }).ToList();
        ...
        public ExamMetaData GetExamDetails(int Exam_Id_V)
        {
            ...
            Ex = (from Exe in CTX.Exams
                  ...
                  select new ExamMetaData { Exam_Id = Exe.Exam_Id, Course_Name = Crs.CourseName, Date = Ex_Dep.Exam_Date, Exam_Degree = Exe.Exam_FullDegree, Exam_Duration = Exe.Exam_Duration, Exam_Name = Exe.Exam_Name }).Single();
